...
; %bb.0:
	...
	cbz	x0, LBB0_26
; %bb.1:
	bl	_VP8LBackrefCostIntervalSearchV2ExperimentEnabled
	cbz	w0, LBB0_3
; %bb.2:
	bl	_VP8LBackrefCostIntervalSearchV2ExperimentInjectFallback
	cbz	w0, LBB0_4
LBB0_3:
	mov	x0, x27
	mov	x1, x26
...
; %bb.0:
	...
	mov	x19, x6
	mov	x27, x5
	stp	x2, x4, [sp, #80]               ; 16-byte Folded Spill
	mov	x25, x3
	mov	x23, x1
	mov	x21, x0
	mov	w8, #1                          ; =0x1
...
Lloh1:
	...
	ldr	x24, [x28, #3232]
	cmp	w19, #1
	str	w25, [sp, #100]                 ; 4-byte Folded Spill
...
Lloh4:
	adrp	x24, _kLog2Table@GOTPAGE
Lloh5:
	ldr	x24, [x24, _kLog2Table@GOTPAGEOFF]
	cmp	w0, #255
	b.hi	LBB1_26
; %bb.23:
	ldr	w23, [x24, w0, uxtw #2]
	b	LBB1_27
LBB1_24:
	cmp	w0, #255
	b.hi	LBB1_83
...
LBB1_62:
	...
	mov	w8, #4095                       ; =0xfff
	str	xzr, [x20, #16]
	ldp	x23, x15, [sp, #64]             ; 16-byte Folded Reload
	cmp	w15, #4095
	csel	w19, w15, w8, lt
	str	xzr, [x20]
	str	xzr, [x26, #448]
...
LBB1_84:
Lloh46:
	adrp	x26, _kLog2Table@GOTPAGE
Lloh47:
	ldr	x26, [x26, _kLog2Table@GOTPAGEOFF]
Lloh48:
	adrp	x27, _VP8LFastLog2Slow@GOTPAGE
Lloh49:
	ldr	x27, [x27, _VP8LFastLog2Slow@GOTPAGEOFF]
...
LBB1_129:
	...
	cmp	w9, #1
	ldp	x6, x5, [sp, #104]              ; 16-byte Folded Reload
	ldp	x30, x7, [sp, #48]              ; 16-byte Folded Reload
	b.lt	LBB1_138
; %bb.130:
	ldur	w10, [x29, #-88]
	ldur	x9, [x29, #-96]
...
LBB1_152:                               ;   in Loop: Header=BB1_144 Depth=1
	...
	cmp	w27, #2
	b.lo	LBB1_157
; %bb.153:                              ;   in Loop: Header=BB1_144 Depth=1
	cmp	w24, w10
	b.ne	LBB1_158
; %bb.154:                              ;   in Loop: Header=BB1_144 Depth=1
	add	w12, w12, w13
	sub	w12, w12, #1
	cmp	w9, #0
...
; %bb.156:                              ;   in Loop: Header=BB1_144 Depth=1
	...
	mov	x2, x22
	b	LBB1_168
LBB1_157:                               ;   in Loop: Header=BB1_144 Depth=1
	mov	x28, x23
	ldr	x8, [x20]
	cbnz	x8, LBB1_183
	b	LBB1_143
...
; %bb.186:                              ;   in Loop: Header=BB1_183 Depth=2
	...
	b	LBB1_182
LBB1_187:                               ;   in Loop: Header=BB1_183 Depth=2
	ldr	x11, [x10, #24]
	add	x12, x11, #32
	cmp	x11, #0
	csel	x12, x20, x12, eq
...
; %bb.45:                               ;   in Loop: Header=BB2_10 Depth=1
	...
	ldr	w3, [sp, #36]                   ; 4-byte Folded Reload
	tbnz	w27, #0, LBB2_9
; %bb.46:                               ;   in Loop: Header=BB2_10 Depth=1
	ldr	x8, [x0, #32]
	cmp	x8, #0
	csel	x8, x0, x19, eq
	b	LBB2_9
