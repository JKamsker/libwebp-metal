#!/usr/bin/env python3
"""Frozen v4 indexed archive builder, inspector, and fail-closed extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-workspace-remote-v4-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-workspace-remote-v4-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-workspace-remote-v4-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-workspace-remote-v4-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
