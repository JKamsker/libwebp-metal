#!/usr/bin/env python3
"""Untimed tests for the frozen interval-specialization alignment v2 indexed evidence archive protocol."""
...
import backref_cost_specialization_alignment_v2_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="specialization-alignment-v2-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-specialization-alignment-v2-stage-v1",
