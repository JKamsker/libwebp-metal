#!/usr/bin/env python3
"""Fail-closed alignment-v1 representative-payload triple-agreement gate."""
...
import backref_cost_specialization_alignment_v1_payload as generator
...
FIXTURE = (ROOT / "evidence/backref-cost-specialization-alignment-v1-design" /
           "representative-payload-fixture.json")
RECEIPT = (ROOT / "evidence/backref-cost-specialization-alignment-v1-design" /
