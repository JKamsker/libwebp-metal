#!/usr/bin/env python3
"""Local identity and direct-child ownership for attribution-v8 transport."""
...
IDENTITY_PATHS = (
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_attribution_v8_experiment_enc.c",
    "src/enc/backref_cost_attribution_v8_experiment_enc.h",
    "tools/backref_cost_attribution_v8_experiment_runner.c",
...
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_attribution_v8_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-attribution-v8-source-admission-receipt-v1"
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="attribution-v8-bundle-") as raw:
