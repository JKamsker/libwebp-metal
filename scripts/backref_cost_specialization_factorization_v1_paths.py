#!/usr/bin/env python3
"""Exact specialization-factorization-v1 run-directory generator, validator, and cleanup guard."""
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-specialization-factorization-v1-path-round-trip-v1",
