#!/usr/bin/env python3
"""Generate fresh alignment-v2 identity fixtures and freeze manifest hashes."""
...
import backref_cost_specialization_alignment_v2_payload as payload
import backref_cost_specialization_alignment_v2_toolchain as toolchain
import backref_cost_specialization_alignment_v2_transport as transport
import test_backref_cost_specialization_alignment_v2_experiment as experiment_test


ROOT = Path(__file__).resolve().parents[1]
MANIFEST = ROOT / "scripts/backref_cost_specialization_alignment_v2_manifest.json"
EVIDENCE = ROOT / "evidence/backref-cost-specialization-alignment-v2-design"
...
def capture_codegen(build_root: Path) -> None:
    runner = build_root / "backref_cost_specialization_alignment_v2_experiment_runner"
    ...
    section_rows = [line for line in map_text.splitlines()
                    if "__TEXT\t__br_align_v2" in line]
    ...
    write_json(EVIDENCE / "phase1-local-codegen.json", {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-local-codegen-v1",
        "status": "PASS",
...
def audit_v4(v4_map: Path) -> None:
    ...
    write_json(EVIDENCE / "phase1-prior-evidence-audit.json", {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-prior-evidence-audit-v1",
...
def fresh_identities(manifest: dict) -> None:
    ...
    payload_fixture = {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-payload-fixture-v1",
    ...
    payload_agreement = {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-payload-agreement-v1",
        "status": "PASS",
        ...
        "generator_path": "scripts/backref_cost_specialization_alignment_v2_payload.py",
        "generator_file_sha256": sha256(ROOT / "scripts/backref_cost_specialization_alignment_v2_payload.py"),
    ...
    write_json(toolchain_fixture_path, {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-toolchain-fixture-v1",
        "identity": toolchain_identity,
    })
    identity_digest = canonical_sha256(toolchain_identity)
    toolchain_agreement = {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-toolchain-agreement-v1",
        "status": "PASS",
    ...
    manifest["build"].update({
        ...
        "identity_rule":
            "one recorder-free Mach-O serves B/L/H; -no_deduplicate preserves six bodies; __TEXT,__br_align_v2 contains Push B/L/H then DP B/L/H at exact 16 KiB entry spacing; linker map, section flags, body facts, normalized instructions, padding and binary bytes are frozen",
    })
    ...
    manifest["acceptance"].update({
        "alignment_normalization": {
            ...
            "inter_entry_padding_bytes":
                codegen["inter_entry_padding_bytes"],
            "local_reference_timed_runner_bytes":
                codegen["timed_runner_bytes"],
            "exact_base_v4_static_runner_bytes": 592688,
            "local_reference_binary_delta_bytes":
                codegen["timed_runner_bytes"] - 592688,
...
def finalize_hashes(manifest: dict) -> None:
    extra = [
        "scripts/freeze_backref_cost_specialization_alignment_v2_phase1.py",
        "scripts/record_backref_cost_specialization_alignment_v2_phase1b.py",
        "evidence/backref-cost-specialization-alignment-v2-design/linker-map.txt",
        "evidence/backref-cost-specialization-alignment-v2-design/linker-map-extract.txt",
        "evidence/backref-cost-specialization-alignment-v2-design/v4-static-audit-linker-map.txt",
        "doc/backref-cost-specialization-alignment-v1-protocol-20260820.md",
        "scripts/backref_cost_specialization_alignment_v1_manifest.json",
        "scripts/backref_cost_specialization_alignment_v1_admission.py",
        "scripts/backref_cost_specialization_alignment_v1_archive.py",
        "scripts/backref_cost_specialization_alignment_v1_paths.py",
        "scripts/backref_cost_specialization_alignment_v1_payload.py",
        "scripts/backref_cost_specialization_alignment_v1_schemas.json",
        "scripts/backref_cost_specialization_alignment_v1_toolchain.py",
        "scripts/backref_cost_specialization_alignment_v1_transport.py",
        "scripts/execute_backref_cost_specialization_alignment_v1.py",
        "scripts/run_backref_cost_specialization_alignment_v1_experiment.py",
        "scripts/evaluate_backref_cost_specialization_alignment_v1.py",
        "src/enc/backref_cost_specialization_alignment_v1_experiment_enc.c",
        "src/enc/backref_cost_specialization_alignment_v1_experiment_enc.h",
        "src/enc/backref_cost_alignment_v1_layout_clone_enc.inc",
        "tools/backref_cost_specialization_alignment_v1_experiment_runner.c",
        "evidence/backref-cost-specialization-alignment-v1-design/phase1-local-codegen.json",
        "evidence/backref-cost-specialization-alignment-v1-design/phase1-local-validation.json",
        "evidence/backref-cost-specialization-alignment-v1-design/phase1b-authorization.json",
        "evidence/backref-cost-specialization-alignment-v1-design/phase1b-rehearsal-hashes.json",
    ]
...
def freeze_source_admission_control(manifest: dict) -> dict:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-specialization-alignment-v2-control-freeze-v1",
        "status": "PASS",
        "construction":
            "actual backref_cost_specialization_alignment_v2_transport.canonical_json and _encoded_json",
        ...
        "positive_alignment_v2_compact_fits_cap": True,
