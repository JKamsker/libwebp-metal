...
import test_backref_cost_attribution_v12_process_ownership as attribution_v12_ownership
...
import test_backref_cost_specialization_alignment_v4_process_ownership as alignment_v4_ownership
import test_backref_cost_aligned_null_stage_attribution_v1_process_ownership as aligned_null_stage_v1_ownership
import test_backref_cost_aligned_null_stage_attribution_v2_process_ownership as aligned_null_stage_v2_ownership
import test_backref_cost_aligned_null_stage_attribution_v3_process_ownership as aligned_null_stage_v3_ownership
...
MATRIX = (
    ...
    (
        ...
        "src/enc/backref_cost_attribution_v12_experiment_enc.o",
    ),
    (
        ...
        "src/enc/backref_cost_attribution_v13_experiment_enc.o",
    ),
    (
        ...
        "src/enc/backref_cost_attribution_v14_experiment_enc.o",
    ),
    (
    ...
    (
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_EXPERIMENT",
    ...
    (
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT",
        "WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT",
        "WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_VARIANT",
        "src/enc/backref_cost_specialization_alignment_v1_experiment_enc.o",
    ),
    (
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V2_EXPERIMENT",
    ...
    (
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT",
        "WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT",
        "WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_VARIANT",
        "src/enc/backref_cost_specialization_alignment_v4_experiment_enc.o",
    ),
    (
        "WEBP_BUILD_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT",
        "WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT",
        "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_VARIANT",
        "src/enc/backref_cost_aligned_null_stage_attribution_v1_experiment_enc.o",
    ),
    (
        ...
        "src/enc/backref_cost_aligned_null_stage_attribution_v2_experiment_enc.o",
    ),
    (
        ...
        "src/enc/backref_cost_aligned_null_stage_attribution_v3_experiment_enc.o",
    ),
)
...
def check_build_matrix() -> None:
    ...
    assert "src/enc/backref_cost_specialization_alignment_v1_experiment_enc.o" not in default.stdout
    ...
    assert "src/enc/backref_cost_specialization_alignment_v4_experiment_enc.o" not in default.stdout
    assert "tools/backref_cost_specialization_alignment_v4_experiment_runner" not in default.stdout
    assert "src/enc/backref_cost_aligned_null_stage_attribution_v1_experiment_enc.o" not in default.stdout
    assert "tools/backref_cost_aligned_null_stage_attribution_v1_experiment_runner" not in default.stdout
    assert "src/enc/backref_cost_aligned_null_stage_attribution_v2_experiment_enc.o" not in default.stdout
    assert "tools/backref_cost_aligned_null_stage_attribution_v2_experiment_runner" not in default.stdout
    assert "src/enc/backref_cost_aligned_null_stage_attribution_v3_experiment_enc.o" not in default.stdout
    assert "tools/backref_cost_aligned_null_stage_attribution_v3_experiment_runner" not in default.stdout
...
def check_v3_v4_mutual_isolation() -> None:
    require_failure([
        "make", "-B", "-n", "-f", "makefile.unix",
        "WEBP_ENABLE_METAL=0",
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V2_EXPERIMENT=1",
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_EXPERIMENT=1",
        "src/enc/backref_cost_specialization_factorization_v3_experiment_enc.o",
    ], "mutually exclusive with overlapping experiments")
    with tempfile.TemporaryDirectory(prefix="factorization-v3-overlap-") as raw:
        require_failure([
            "cmake", "-S", ".", "-B", raw,
    ...
    with tempfile.TemporaryDirectory(prefix="alignment-v4-overlap-") as raw:
        require_failure([
            "cmake", "-S", ".", "-B", raw,
            "-DWEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT=ON",
            "-DWEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT=ON",
        ], "mutually exclusive with")
    require_failure([
        "make", "-B", "-n", "-f", "makefile.unix",
        "WEBP_ENABLE_METAL=0",
    ...
    require_failure([
        "make", "-B", "-n", "-f", "makefile.unix", "WEBP_ENABLE_METAL=0",
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_EXPERIMENT=1",
        "WEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT=1",
        "src/enc/backref_cost_specialization_alignment_v1_experiment_enc.o",
    ], "mutually exclusive with overlapping experiments")
    with tempfile.TemporaryDirectory(prefix="alignment-v1-overlap-") as raw:
        require_failure([
            "cmake", "-S", ".", "-B", raw,
            "-DWEBP_BUILD_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_EXPERIMENT=ON",
    ...
    with tempfile.TemporaryDirectory(prefix="alignment-v2-overlap-") as raw:
        require_failure([
            "cmake", "-S", ".", "-B", raw,
            "-DWEBP_BUILD_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT=ON",
...
def main() -> int:
    ...
    attribution_v12_ownership.main()
    ...
    alignment_v4_ownership.main()
    aligned_null_stage_v1_ownership.main()
    aligned_null_stage_v2_ownership.main()
    aligned_null_stage_v3_ownership.main()
    check_build_matrix()
    check_v3_v4_mutual_isolation()
    check_omitted_targets()
    check_promoted_ablation_control()
    check_runtime_and_lease_refusals()
    print("PASS: forty-seven independent build/runtime guards, fail-closed "
