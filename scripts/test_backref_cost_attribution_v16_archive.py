#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v16 indexed evidence archive protocol."""
...
import backref_cost_attribution_v16_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v16-archive-test-") as raw:
        ...
        print(json.dumps({
            "fixture": "compact-120-stage-record-archive",
