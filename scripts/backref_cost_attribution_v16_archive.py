#!/usr/bin/env python3
"""Frozen attribution-v16 indexed archive builder and extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-attribution-v16-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-attribution-v16-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-attribution-v16-artifact-hashes-v1"
RETURNED_SCHEMA = (
