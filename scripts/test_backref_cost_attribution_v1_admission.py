...
from backref_cost_attribution_v1_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="attribution-v1-path-home-") as raw:
...
def repository_context_admission_tests() -> None:
    with tempfile.TemporaryDirectory(prefix="attribution-v1-admit-test-") as raw:
...
def main() -> int:
    ...
    print("PASS: attribution v1 canonical paths, repository-context bundle verification, "
