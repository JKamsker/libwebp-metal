#!/usr/bin/env python3
"""Exact interval-search v3 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-interval-search-v3"
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-interval-search-v3-path-round-trip-v1",
