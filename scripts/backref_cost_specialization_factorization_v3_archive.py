#!/usr/bin/env python3
"""Frozen specialization-factorization-v3 indexed archive builder and extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-specialization-factorization-v3-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-specialization-factorization-v3-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-specialization-factorization-v3-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-specialization-factorization-v3-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
