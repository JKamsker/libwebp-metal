#!/usr/bin/env python3
"""Exact specialization-alignment-v3 run-directory generator, validator, and cleanup guard."""
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-specialization-alignment-v3-path-round-trip-v1",
