#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v3 indexed evidence archive protocol."""
...
import backref_cost_attribution_v3_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v3-archive-test-") as raw:
