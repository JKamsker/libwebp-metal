#!/usr/bin/env python3
"""Local identity and direct-child ownership for specialization-alignment-v4 transport."""
...
IDENTITY_PATHS = (
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_specialization_alignment_v4_experiment_enc.c",
    "src/enc/backref_cost_specialization_alignment_v4_experiment_enc.h",
    "src/enc/backref_cost_alignment_v4_layout_clone_enc.inc",
    "tools/backref_cost_specialization_alignment_v4_experiment_runner.c",
    ...
    "scripts/backref_cost_specialization_alignment_v4_payload.py",
    "scripts/execute_backref_cost_specialization_alignment_v4.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_specialization_alignment_v4_manifest.json"
...
CHILD_START_SCHEMA = \
    "libwebp-backref-cost-specialization-alignment-v4-child-start-v1"
CHILD_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-specialization-alignment-v4-child-receipt-v1"
...
class DirectRunnerLedger:
    ...
    def run(self, argv: list[str], *, cwd: Path, env: dict[str, str],
        ...
        child_env = dict(env)
        child_env.update({
            "WEBP_ALIGNMENT_V4_DIRECT_CHILD": "1",
            "WEBP_ALIGNMENT_V4_CHILD_ORDINAL": str(ordinal),
            "WEBP_ALIGNMENT_V4_CHILD_CREATION_TOKEN": creation_identity,
            "WEBP_ALIGNMENT_V4_CHILD_PURPOSE": purpose,
            "WEBP_ALIGNMENT_V4_CHILD_LIFECYCLE": lifecycle,
            "WEBP_ALIGNMENT_V4_CHILD_CASE_ID": case_id,
            "WEBP_ALIGNMENT_V4_CHILD_METHOD": str(method),
        })
    ...
    def finalize(self, expected_count: int) -> dict:
        ...
        return {"schema":
                "libwebp-backref-cost-specialization-alignment-v4-child-summary-v1",
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="specialization-alignment-v4-bundle-") as raw:
