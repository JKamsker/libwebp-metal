#!/usr/bin/env python3
"""Local identity and direct-child ownership for specialization-factorization-v3 transport."""
...
IDENTITY_PATHS = (
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_specialization_factorization_v3_experiment_enc.c",
    "src/enc/backref_cost_specialization_factorization_v3_experiment_enc.h",
    "src/enc/backref_cost_factorization_v3_layout_clone_enc.inc",
    "tools/backref_cost_specialization_factorization_v3_experiment_runner.c",
    ...
    "scripts/backref_cost_specialization_factorization_v3_payload.py",
    "scripts/execute_backref_cost_specialization_factorization_v3.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_specialization_factorization_v3_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-specialization-factorization-v3-source-admission-receipt-v1"
...
class TransportDeadlineStateMachine:
    """Pure Factorization V3 transport deadline attribution with injected monotonic time."""
...
def pump_owned_full_duplex(
    ...
    if stdout_observer is None or not hasattr(stdout_observer,
                                               "transport_state"):
        raise ValueError("Factorization V3 transport requires an online state observer")
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="specialization-factorization-v3-bundle-") as raw:
