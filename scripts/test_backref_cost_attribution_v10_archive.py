#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v10 indexed evidence archive protocol."""
...
import backref_cost_attribution_v10_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v10-archive-test-") as raw:
