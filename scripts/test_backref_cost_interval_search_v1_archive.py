#!/usr/bin/env python3
"""Untimed tests for the frozen interval-search v1 indexed evidence archive protocol."""
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="interval-search-v1-archive-test-") as raw:
