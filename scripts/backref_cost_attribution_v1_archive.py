...
ARCHIVE_SCHEMA = "libwebp-backref-cost-attribution-v1-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-attribution-v1-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-attribution-v1-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-attribution-v1-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
