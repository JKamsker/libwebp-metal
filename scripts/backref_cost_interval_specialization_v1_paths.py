#!/usr/bin/env python3
"""Exact interval-specialization v1 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-interval-specialization-v1"
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-interval-specialization-v1-path-round-trip-v1",
