#!/usr/bin/env python3
"""Record the sole stage-attribution-v2 rehearsal as Phase 1B evidence."""
...
DESIGN = ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v2-design"
...
PROTOCOL = ROOT / "doc/backref-cost-aligned-null-stage-attribution-v2-protocol-20260820.md"
SCHEMAS = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v2_schemas.json"
TRANSPORT = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v2_transport.py"
...
def main() -> int:
    ...
    rows = artifact_rows()
    index = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v2-phase1b-hash-index-v1",
    ...
    authorization = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v2-authorization-v1",
        ...
        "authorization_scope": (
            "Phase 2 may make exactly one frozen stage-attribution-v2 diagnostic transaction. No performance sample is admitted until dynamic correctness, timer-accounting, and online direct-child gates pass inside that invocation; no production promotion, retry, or other workload is authorized."
            if passed else "Phase 2 is unauthorized."),
        "base_commit": "fb297dd1097f6fc5a2f2d4d453da3c24b235d7d1",
        "branch": "codex/backref-cost-aligned-null-stage-attribution-v2",
        "source_commit": source_commit, "source_tree": source_tree,
