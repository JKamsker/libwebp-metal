#!/usr/bin/env python3
"""Frozen local driver for one stage-attribution-v3 single-session transaction."""
...
PROTOCOL_PATH = ROOT / "doc" / "backref-cost-aligned-null-stage-attribution-v3-protocol-20260820.md"
TRANSPORT_PATH = ROOT / "scripts" / "backref_cost_aligned_null_stage_attribution_v3_transport.py"
BOOTSTRAP_PATH = ROOT / "scripts" / "backref_cost_aligned_null_stage_attribution_v3_bootstrap.py"
PAYLOAD_GENERATOR_PATH = \
    ROOT / "scripts" / "backref_cost_aligned_null_stage_attribution_v3_payload.py"
AUTHORIZATION_PATH = (ROOT / "evidence" / "backref-cost-aligned-null-stage-attribution-v3-design" /
...
REHEARSAL_ROOT = (ROOT / "evidence" / "backref-cost-aligned-null-stage-attribution-v3-design" /
                  "rehearsal")
EXPECTED_ENV = "EXPECTED_FREEZE_COMMIT"
AUTHORIZATION_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-authorization-v1"
REHEARSAL_HASH_INDEX_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-phase1b-hash-index-v1"
...
def _allowed_phase1b_path(path: str) -> bool:
    prefix = "evidence/backref-cost-aligned-null-stage-attribution-v3-design/rehearsal/"
    return path.startswith(prefix) or path in {
        "evidence/backref-cost-aligned-null-stage-attribution-v3-design/phase1b-rehearsal-hashes.json",
        "evidence/backref-cost-aligned-null-stage-attribution-v3-design/phase1b-authorization.json",
    }
...
def validate_authority_values(*, envelope: dict | None, head_commit: str,
    ...
    if envelope.get("authorization_status") != "AUTHORIZED" or \
            ...
            "ALIGNED_NULL_STAGE_ATTRIBUTION_V3_CONDITIONAL_DIAGNOSTIC_AUTHORITY" or \
...
def validate_authorized_handoff(head: str) -> str:
    ...
    hashes = {
        "manifest": _git_file_sha256(
            source_commit, "scripts/backref_cost_aligned_null_stage_attribution_v3_manifest.json"),
        "protocol": _git_file_sha256(
            source_commit, "doc/backref-cost-aligned-null-stage-attribution-v3-protocol-20260820.md"),
        "schemas": _git_file_sha256(
            source_commit, "scripts/backref_cost_aligned_null_stage_attribution_v3_schemas.json"),
        "transport": _git_file_sha256(
            source_commit, "scripts/backref_cost_aligned_null_stage_attribution_v3_transport.py"),
    }
...
def lease_transfer_contract(mode: str, attempted: bool,
    ...
    if not attempted:
        return ({"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-lease-transfer-v1",
...
def _transport_command(*, transaction_nonce: str,
    ...
    remote = (
        "exec /usr/bin/env "
        f"WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_TRANSACTION_NONCE={transaction_nonce} "
        f"WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_REQUEST_DECLARATION_SHA256={request_declaration_sha256} "
        f"WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_BOOTSTRAP_SHA256={bootstrap_sha256} "
...
def remote_pipeline(output: Path, mode: str) -> dict:
    ...
    def persist_transport_refusal(*, failure: str, timeout_phase: str | None,
        ...
        write_json(protocol / "request-progress.json", {
            "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-request-progress-v1",
        ...
        write_json(output / "transfer-cleanup.json", {
            "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-transfer-cleanup-v1",
    ...
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v3-return-") as raw:
        temporary = Path(raw)
        try:
