#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v4 indexed evidence archive protocol."""
...
import backref_cost_attribution_v4_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v4-archive-test-") as raw:
