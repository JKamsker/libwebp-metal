#!/usr/bin/env python3
"""Exact specialization-factorization-v2 run-directory generator, validator, and cleanup guard."""
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-specialization-factorization-v2-path-round-trip-v1",
