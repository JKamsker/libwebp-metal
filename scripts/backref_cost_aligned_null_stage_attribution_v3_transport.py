#!/usr/bin/env python3
"""Framed single-session transport for aligned-null stage attribution v3.
...
import backref_cost_aligned_null_stage_attribution_v3_payload as payload_generator


MAGIC = b"LIBWEBP-BACKREF-COST-ALIGNED-NULL-STAGE-ATTRIBUTION-V3-FRAMES\x00\x01\n"
PROTOCOL_VERSION = 1
CHANNEL_MAGIC = b"LIBWEBP-BACKREF-COST-ALIGNED-NULL-STAGE-ATTRIBUTION-V3-CHANNEL\x00\x01\n"
CHANNEL_READY_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-ready-v1"
REQUEST_DECLARATION_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-request-declaration-v1"
REQUEST_ACK_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-request-ack-v1"
REQUEST_CHUNK_ACK_SCHEMA = "br-null-v3-chunk-ack-v1"
RESPONSE_DECLARATION_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-response-declaration-v1"
RESPONSE_COMPLETE_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-response-complete-v1"
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-aligned-null-stage-attribution-v3"
RUN_PREFIX = "run."
...
BULK_DECLARATION_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-archive-v1"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-source-admission-receipt-v1"
SOURCE_DETAILS_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-source-admission-details-v1"
...
DENIED_RAW_COMM_IDENTITIES = frozenset({
    ...
    "backref_cost_aligned_null_stage_attribution_v3_experiment_runner",
...
class ProcessRefusal(FrameRefusal):
    ...
    def __init__(self, failure_code: str, *, row: dict | None = None,
        ...
        self.diagnostic = {
            "schema":
                "libwebp-backref-cost-aligned-null-stage-attribution-v3-process-refusal-v1",
    ...
    def _valid_bulk_declaration(self, declaration: dict) -> bool:
        ...
        valid = (
            ...
            inventory.get("schema") ==
                "libwebp-backref-cost-aligned-null-stage-attribution-v3-archive-inventory-v1" and
        ...
        if process_refusal is not None:
            ...
            if not isinstance(process_refusal, dict) or \
                    ...
                    process_refusal.get("schema") != (
                        "libwebp-backref-cost-aligned-null-stage-attribution-v3-process-refusal-v1") or \
...
def remote_transaction(input_stream) -> tuple[int, bytes]:
    ...
    sequence = 0
    success = False
    cleanup = {"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-cleanup-receipt-v1",
    ...
    lease_state = {"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-lease-transfer-v1",
    ...
    try:
        ...
        if mode == "run":
            ...
            environment["WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_REHEARSAL_PAYLOAD"] = str(payload_path)
            environment["WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_REHEARSAL_PAYLOAD_SHA256"] = sha256_bytes(payload)
            environment["WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_REHEARSAL_PAYLOAD_BYTES"] = str(len(payload))
        operator = _run([
            sys.executable,
            "scripts/run_backref_cost_aligned_null_stage_attribution_v3_experiment.py", mode,
        ...
        _add_indexed_detail(
            evidence, "remote-admission-process-isolation.json", {
                "schema":
                    "libwebp-backref-cost-aligned-null-stage-attribution-v3-remote-process-isolation-v1",
                "status": "verified",
        ...
        if attempted is False:
            lease_state = {
                "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-lease-transfer-v1",
        ...
        builder = _run([
            sys.executable, "scripts/backref_cost_aligned_null_stage_attribution_v3_archive.py", "build",
    ...
    integrity = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-integrity-footer-v1",
    ...
    if child is not None:
        try:
            ...
            cleanup = {
                "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-cleanup-receipt-v1",
