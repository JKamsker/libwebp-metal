#!/usr/bin/env python3
"""Shared fail-closed source admission for remote-v3 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_workspace_remote_v3_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    "src/enc/backward_references_cost_enc.c",
    "src/enc/backref_cost_workspace_remote_v3_experiment_enc.c",
    "src/enc/backref_cost_workspace_remote_v3_experiment_enc.h",
    "tools/backref_cost_workspace_remote_v3_experiment_runner.c",
...
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_workspace_remote_v3_manifest.json"
SCOPED_NAMES = {
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="remote-v3-admission-")
