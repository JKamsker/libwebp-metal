#!/usr/bin/env python3
"""Static, workload-free process-ownership guards for attribution v1."""
...
INFRASTRUCTURE = (
    ...
    "scripts/backref_cost_attribution_v1_archive.py",
    "scripts/backref_cost_attribution_v1_paths.py",
    "scripts/execute_backref_cost_attribution_v1.py",
    "scripts/run_backref_cost_attribution_v1_experiment.py",
)
    ...
    for relative in INFRASTRUCTURE:
        ...
        for node in ast.walk(tree):
            ...
            if name == "subprocess.Popen":
                assert relative == "scripts/backref_cost_attribution_v1_admission.py"
            if name == "subprocess.run":
                assert relative == "scripts/backref_cost_attribution_v1_paths.py"
...
def main() -> int:
    ...
    cleanup_contract()
    print("PASS: attribution v1 signals only its retained direct-child handle; "
