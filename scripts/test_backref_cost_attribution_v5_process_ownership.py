#!/usr/bin/env python3
"""Static, workload-free process-ownership guards for attribution v5."""
...
import backref_cost_attribution_v5_admission as admission


ROOT = Path(__file__).resolve().parents[1]
INFRASTRUCTURE = (
    "scripts/backref_cost_attribution_v5_admission.py",
    "scripts/backref_cost_attribution_v5_archive.py",
    "scripts/backref_cost_attribution_v5_paths.py",
    "scripts/execute_backref_cost_attribution_v5.py",
    "scripts/run_backref_cost_attribution_v5_experiment.py",
)
    ...
    for relative in INFRASTRUCTURE:
        ...
        for node in ast.walk(tree):
            ...
            if name == "subprocess.Popen":
                assert relative == "scripts/backref_cost_attribution_v5_admission.py"
            if name == "subprocess.run":
                assert relative == "scripts/backref_cost_attribution_v5_paths.py"
...
def main() -> int:
    ...
    cleanup_contract()
    print("PASS: attribution v5 signals only its retained direct-child handle; "
