#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v9 indexed evidence archive protocol."""
...
import backref_cost_attribution_v9_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v9-archive-test-") as raw:
