#!/usr/bin/env python3
"""Fail-closed stage-attribution-v3 payload triple-agreement gate."""
...
import backref_cost_aligned_null_stage_attribution_v3_payload as generator
...
FIXTURE = (ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v3-design" /
           "representative-payload-fixture.json")
RECEIPT = (ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v3-design" /
           "representative-payload-agreement.json")


def independent_digest(size: int) -> str:
    domain = b"libwebp-backref-cost-aligned-null-stage-attribution-v3-rehearsal\x00"
