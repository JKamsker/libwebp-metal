#!/usr/bin/env python3
"""Untimed unit tests for v3 paths, repository-context admission, and sharing."""
...
import execute_backref_cost_workspace_remote_v3 as executor
from backref_cost_workspace_remote_v3_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="remote-v3-path-home-") as raw:
...
def main() -> int:
    ...
    shared_path_test()
    print("PASS: v3 canonical paths, repository-context bundle verification, "
