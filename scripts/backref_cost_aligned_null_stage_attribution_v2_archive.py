#!/usr/bin/env python3
"""Frozen stage-attribution-v2 indexed archive builder and extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-aligned-null-stage-attribution-v2-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-aligned-null-stage-attribution-v2-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-aligned-null-stage-attribution-v2-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-aligned-null-stage-attribution-v2-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
