#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v11 indexed evidence archive protocol."""
...
import backref_cost_attribution_v11_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v11-archive-test-") as raw:
