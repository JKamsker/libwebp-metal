...
BASE = "fb297dd1097f6fc5a2f2d4d453da3c24b235d7d1"
BUILD = "WEBP_BUILD_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT"
RECORDER = "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_RECORDER"
MACRO = "WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT"
RUNTIME = "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_VARIANT"
RUNNER = "backref_cost_aligned_null_stage_attribution_v2_experiment_runner"
...
def main() -> int:
    ...
    assert "VP8LBackrefCostAlignedNullStageAttributionV2GetVariant" in source
    ...
    with tempfile.TemporaryDirectory(
        ...
        assert b"SPECIALIZATION_ALIGNED_NULL_STAGE_ATTRIBUTION_V2" not in ordinary_archive
        ...
        assert "AlignedNullStageAttributionV2RecordPush" not in timed_nm
        assert "AlignedNullStageAttributionV2RecordPush" in recorder_nm
        ...
        section_map_rows = [line for line in map_text.splitlines()
                            if "__TEXT\t__br_null_v2" in line]
