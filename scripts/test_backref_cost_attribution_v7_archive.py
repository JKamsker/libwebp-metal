#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v7 indexed evidence archive protocol."""
...
import backref_cost_attribution_v7_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v7-archive-test-") as raw:
