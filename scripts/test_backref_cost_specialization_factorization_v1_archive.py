#!/usr/bin/env python3
"""Untimed tests for the frozen interval-specialization factorization v1 indexed evidence archive protocol."""
...
import backref_cost_specialization_factorization_v1_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="specialization-factorization-v1-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-specialization-factorization-v1-stage-v1",
