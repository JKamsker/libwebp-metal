#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v2 indexed evidence archive protocol."""
...
import backref_cost_attribution_v2_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v2-archive-test-") as raw:
