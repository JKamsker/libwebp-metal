#!/usr/bin/env python3
"""Untimed tests for the frozen interval-specialization aligned null stage attribution v1 indexed evidence archive protocol."""
...
import backref_cost_aligned_null_stage_attribution_v1_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v1-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-stage-ledger-v1",
