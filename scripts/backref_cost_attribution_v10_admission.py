#!/usr/bin/env python3
"""Local identity and direct-child ownership for attribution-v10 transport."""
...
IDENTITY_PATHS = (
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_attribution_v10_experiment_enc.c",
    "src/enc/backref_cost_attribution_v10_experiment_enc.h",
    "tools/backref_cost_attribution_v10_experiment_runner.c",
...
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_attribution_v10_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-attribution-v10-source-admission-receipt-v1"
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="attribution-v10-bundle-") as raw:
