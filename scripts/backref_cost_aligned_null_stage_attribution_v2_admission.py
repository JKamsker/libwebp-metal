#!/usr/bin/env python3
"""Local identity and direct-child ownership for stage-attribution-v2."""
...
HOST = "pandocs-agent"
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_aligned_null_stage_attribution_v2_manifest.json"
...
CHILD_START_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v2-child-start-v1"
CHILD_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-aligned-null-stage-attribution-v2-child-receipt-v1"
...
class DirectRunnerLedger:
    ...
    def run(self, argv: list[str], *, cwd: Path, env: dict[str, str],
        ...
        child_env = dict(env)
        child_env.update({
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_DIRECT_CHILD": "1",
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_ORDINAL": str(ordinal),
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_CREATION_TOKEN": creation_identity,
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_PURPOSE": purpose,
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_LIFECYCLE": lifecycle,
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_CASE_ID": case_id,
            "WEBP_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_CHILD_METHOD": str(method),
        })
    ...
    def finalize(self, expected_count: int) -> dict:
        ...
        return {"schema":
                "libwebp-backref-cost-aligned-null-stage-attribution-v2-child-summary-v1",
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v2-bundle-") as raw:
