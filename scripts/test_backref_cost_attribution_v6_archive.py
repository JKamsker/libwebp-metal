#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v6 indexed evidence archive protocol."""
...
import backref_cost_attribution_v6_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v6-archive-test-") as raw:
