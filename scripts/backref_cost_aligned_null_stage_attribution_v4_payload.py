#!/usr/bin/env python3
"""Canonical deterministic stage-attribution-v4 payload generator."""
...
DOMAIN_TEXT = "libwebp-backref-cost-aligned-null-stage-attribution-v4-rehearsal\\0"
...
def identity() -> dict[str, object]:
    digest = sha256()
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v4-payload-identity-v1",
        ...
        "stale_alignment_v4_sha256": STALE_ALIGNMENT_V4_SHA256,
        ...
        "stale_alignment_v4_rejected": digest != STALE_ALIGNMENT_V4_SHA256,
    }
