#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v1 indexed evidence archive protocol."""
...
import backref_cost_attribution_v1_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v1-archive-test-") as raw:
