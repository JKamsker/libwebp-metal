#!/usr/bin/env python3
"""Canonical deterministic V4-domain representative-payload generator."""
...
DOMAIN_TEXT = "libwebp-backref-cost-specialization-factorization-v4-rehearsal\\0"
...
def identity() -> dict[str, object]:
    digest = sha256()
    return {
        "schema": "libwebp-backref-cost-specialization-factorization-v4-payload-identity-v1",
