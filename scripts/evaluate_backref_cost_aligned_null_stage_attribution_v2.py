...
EXPECTED_RECEIPT = (ROOT /
    "evidence/backref-cost-aligned-null-stage-attribution-v2-design/four-body-expected-receipt.json")
TOP_LEVEL = (
...
def evaluate(evidence: Path) -> dict:
    ...
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v2-evaluation-v1",
