#!/usr/bin/env python3
"""Exact remote v2 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-workspace-remote-v2"
...
def generate() -> dict:
    ...
    try:
        ...
        # An unvalidated path is never recursively removed here.
        raise
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-workspace-remote-v2-path-round-trip-v1",
