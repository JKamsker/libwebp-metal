#!/usr/bin/env python3
"""Shared fail-closed source admission for attribution-v5 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_attribution_v5_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_attribution_v5_experiment_enc.c",
    "src/enc/backref_cost_attribution_v5_experiment_enc.h",
    "tools/backref_cost_attribution_v5_experiment_runner.c",
    "scripts/backref_cost_attribution_v5_paths.py",
    "scripts/backref_cost_attribution_v5_admission.py",
    "scripts/execute_backref_cost_attribution_v5.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_attribution_v5_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-attribution-v5-source-admission-receipt-v1"
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="attribution-v5-admission-")
