#!/usr/bin/env python3
"""Untimed tests for the frozen interval-specialization v1 indexed evidence archive protocol."""
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="interval-specialization-v1-archive-test-") as raw:
