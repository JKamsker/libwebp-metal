#!/usr/bin/env python3
"""Untimed tests for the frozen interval-specialization aligned null stage attribution v2 indexed evidence archive protocol."""
...
import backref_cost_aligned_null_stage_attribution_v2_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v2-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v2-stage-ledger-v1",
             "ordinal": ordinal, "case_id":
                 "photo-large" if ordinal < 80 else "graphic-large",
             "method": 4 if ordinal % 2 == 0 else 6,
             "variant": ("B", "L")[ordinal % 2],
        ...
        print(json.dumps({
            "fixture": "compact-160-stage-record-archive",
