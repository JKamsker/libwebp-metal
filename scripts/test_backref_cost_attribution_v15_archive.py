#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v15 indexed evidence archive protocol."""
...
import backref_cost_attribution_v15_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v15-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-attribution-v15-stage-v1",
