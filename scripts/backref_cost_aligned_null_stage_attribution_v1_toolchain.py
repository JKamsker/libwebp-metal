#!/usr/bin/env python3
"""Canonical pinned-Xcode toolchain identity for Aligned Null Stage Attribution V1."""
...
def identity() -> dict[str, object]:
    ...
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-toolchain-identity-v1",
