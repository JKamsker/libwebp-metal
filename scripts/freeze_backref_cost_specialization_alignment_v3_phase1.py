#!/usr/bin/env python3
"""Generate fresh alignment-v3 identity fixtures and freeze manifest hashes."""
...
import backref_cost_specialization_alignment_v3_payload as payload
...
import test_backref_cost_specialization_alignment_v3_experiment as experiment_test
...
def capture_codegen(build_root: Path) -> None:
    runner = build_root / "backref_cost_specialization_alignment_v3_experiment_runner"
    ...
    write_json(EVIDENCE / "phase1-local-codegen.json", {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-local-codegen-v1",
        "status": "PASS",
...
def audit_v4(v4_map: Path) -> None:
    ...
    write_json(EVIDENCE / "phase1-prior-evidence-audit.json", {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-prior-evidence-audit-v1",
...
def fresh_identities(manifest: dict) -> None:
    ...
    payload_fixture = {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-payload-fixture-v1",
    ...
    payload_agreement = {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-payload-agreement-v1",
        "status": "PASS",
        ...
        "generator_path": "scripts/backref_cost_specialization_alignment_v3_payload.py",
        "generator_file_sha256": sha256(ROOT / "scripts/backref_cost_specialization_alignment_v3_payload.py"),
    ...
    write_json(toolchain_fixture_path, {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-toolchain-fixture-v1",
        "identity": toolchain_identity,
    })
    identity_digest = canonical_sha256(toolchain_identity)
    toolchain_agreement = {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-toolchain-agreement-v1",
        "status": "PASS",
    ...
    manifest["payload_identity_gate"].update({
        "sha256": payload_identity["sha256"],
        "negative_test": "PASS_REJECTED_V2_V3_V4_AND_ALIGNMENT_V1",
    ...
    manifest["toolchain_identity_gate"].update({
        "negative_test": "PASS_REJECTED_STALE_V2_XCRUN_AND_V3_V4_ALIGNMENT_V1_ENVELOPES",
    })
    manifest["build"].update({
        "ld": str(toolchain.EXECUTABLE_PATHS["ld"]),
        "otool": str(toolchain.EXECUTABLE_PATHS["otool"]),
        "identity_rule":
            "one recorder-free Mach-O serves B/L/H; -no_deduplicate preserves six bodies; __TEXT,__br_align_v3 contains Push B/L/H then DP B/L/H at exact 16 KiB entry spacing; linker map, section flags, body facts, normalized instructions, padding and binary bytes are frozen",
    })
...
def freeze_request_channel_sizes(manifest: dict) -> dict:
    ...
    bootstrap_path = ROOT / \
        "scripts/backref_cost_specialization_alignment_v3_bootstrap.py"
    bootstrap_sha = sha256(bootstrap_path)
    request = transport.build_channel_request(
        (ROOT / "scripts/backref_cost_specialization_alignment_v3_transport.py").read_bytes(),
        (ROOT / "scripts/backref_cost_specialization_alignment_v3_payload.py").read_bytes(),
    ...
    with tempfile.TemporaryDirectory(prefix="alignment-v3-base-bundle-") as raw:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-specialization-alignment-v3-request-size-freeze-v1",
...
def freeze_local_validation(manifest: dict, request_sizes: dict) -> None:
    ...
    write_json(EVIDENCE / "phase1-local-validation.json", {
        "schema":
            "libwebp-backref-cost-specialization-alignment-v3-phase1-local-validation-v1",
        ...
        "remote_contacts": 0,
        "design_decision": "SIX_BODY_16K_ALIGNMENT_PRESERVED_WITH_READY_GATED_SINGLE_SESSION",
        "checks": {
            ...
            "mach_o_section": "PASS___TEXT___br_align_v3_EXECUTABLE_PURE_INSTRUCTIONS",
            ...
            "global_experiment_mutual_exclusion": "PASS_43_GUARDS",
        ...
        "commands": [
            "python3 -m py_compile scripts/*alignment_v3*.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_payload_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_toolchain_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_process_ownership.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_archive.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_streaming.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_admission.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_experiment.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_specialization_alignment_v3_protocol.py",
...
def freeze_source_admission_control(manifest: dict) -> dict:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-specialization-alignment-v3-control-freeze-v1",
        "status": "PASS",
        "construction":
            "actual backref_cost_specialization_alignment_v3_transport.canonical_json and _encoded_json",
        ...
        "positive_alignment_v3_compact_fits_cap": True,
