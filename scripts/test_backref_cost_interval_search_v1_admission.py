...
import execute_backref_cost_interval_search_v1 as executor
from backref_cost_interval_search_v1_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="interval-search-v1-path-home-") as raw:
...
def repository_context_admission_tests() -> None:
    with tempfile.TemporaryDirectory(prefix="interval-search-v1-admit-test-") as raw:
