#!/usr/bin/env python3
"""Frozen v5 indexed archive builder, inspector, and fail-closed extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-interval-specialization-v1-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-interval-specialization-v1-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-interval-specialization-v1-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-interval-specialization-v1-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
...
def build_archive(root: Path, index: Path, archive: Path,
    ...
    members: list[dict] = []
    with tarfile.open(archive, "w:gz", format=tarfile.GNU_FORMAT) as opened:
