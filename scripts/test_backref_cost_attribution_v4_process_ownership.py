#!/usr/bin/env python3
"""Static, workload-free process-ownership guards for attribution v4."""
...
INFRASTRUCTURE = (
    ...
    "scripts/backref_cost_attribution_v4_archive.py",
    "scripts/backref_cost_attribution_v4_paths.py",
    "scripts/execute_backref_cost_attribution_v4.py",
    "scripts/run_backref_cost_attribution_v4_experiment.py",
)
    ...
    for relative in INFRASTRUCTURE:
        ...
        for node in ast.walk(tree):
            ...
            if name == "subprocess.Popen":
                assert relative == "scripts/backref_cost_attribution_v4_admission.py"
            if name == "subprocess.run":
                assert relative == "scripts/backref_cost_attribution_v4_paths.py"
...
def main() -> int:
    ...
    cleanup_contract()
    print("PASS: attribution v4 signals only its retained direct-child handle; "
