#!/usr/bin/env python3
"""Local identity and direct-child ownership for specialization-alignment-v3 transport."""
...
IDENTITY_PATHS = (
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_specialization_alignment_v3_experiment_enc.c",
    "src/enc/backref_cost_specialization_alignment_v3_experiment_enc.h",
    "src/enc/backref_cost_alignment_v3_layout_clone_enc.inc",
    "tools/backref_cost_specialization_alignment_v3_experiment_runner.c",
    ...
    "scripts/backref_cost_specialization_alignment_v3_payload.py",
    "scripts/execute_backref_cost_specialization_alignment_v3.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_specialization_alignment_v3_manifest.json"
...
def create_source_bundle() -> tuple[bytes, str]:
    ...
    with tempfile.TemporaryDirectory(prefix="specialization-alignment-v3-bundle-") as raw:
