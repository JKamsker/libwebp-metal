#!/usr/bin/env python3
"""Record the sole alignment-v4 rehearsal as additions-only Phase 1B evidence."""
...
PROTOCOL = ROOT / "doc/backref-cost-specialization-alignment-v4-protocol-20260820.md"
SCHEMAS = ROOT / "scripts/backref_cost_specialization_alignment_v4_schemas.json"
TRANSPORT = ROOT / "scripts/backref_cost_specialization_alignment_v4_transport.py"
...
def main() -> int:
    ...
    rows = artifact_rows()
    index = {
        "schema": "libwebp-backref-cost-specialization-alignment-v4-phase1b-hash-index-v1",
    ...
    authorization = {
        "schema": "libwebp-backref-cost-specialization-alignment-v4-authorization-v1",
        ...
        "authorization_scope": (
            "Phase 2 may make exactly one frozen alignment-v4 diagnostic transaction. No performance sample is admitted until dynamic correctness, timer-accounting, and online direct-child gates pass inside that invocation; no production promotion, retry, or other workload is authorized."
            if passed else "Phase 2 is unauthorized."),
        "base_commit": "91ab79b70bb1f99888dce63e8b1ac512741bafb3",
        "branch": "codex/backref-cost-specialization-alignment-v4",
        "source_commit": source_commit, "source_tree": source_tree,
