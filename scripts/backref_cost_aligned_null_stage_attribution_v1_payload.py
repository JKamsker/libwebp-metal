#!/usr/bin/env python3
"""Canonical deterministic stage-attribution-v1 payload generator."""
...
DOMAIN_TEXT = "libwebp-backref-cost-aligned-null-stage-attribution-v1-rehearsal\\0"
...
def identity() -> dict[str, object]:
    digest = sha256()
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-payload-identity-v1",
