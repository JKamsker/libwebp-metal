#!/usr/bin/env python3
"""Frozen attribution-v5 indexed archive builder and extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-attribution-v5-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-attribution-v5-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-attribution-v5-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-attribution-v5-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
