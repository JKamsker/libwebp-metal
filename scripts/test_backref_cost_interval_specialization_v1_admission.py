...
from backref_cost_interval_specialization_v1_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="interval-specialization-v1-path-home-") as raw:
...
def repository_context_admission_tests() -> None:
    with tempfile.TemporaryDirectory(prefix="interval-specialization-v1-admit-test-") as raw:
...
def main() -> int:
    ...
    print("PASS: specialization v1 canonical paths, repository-context bundle verification, "
