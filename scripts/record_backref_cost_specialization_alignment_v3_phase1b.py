#!/usr/bin/env python3
"""Record the sole alignment-v3 rehearsal as additions-only Phase 1B evidence."""
...
DESIGN = ROOT / "evidence/backref-cost-specialization-alignment-v3-design"
...
PROTOCOL = ROOT / "doc/backref-cost-specialization-alignment-v3-protocol-20260820.md"
...
def main() -> int:
    ...
    rows = artifact_rows()
    index = {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-phase1b-hash-index-v1",
    ...
    authorization = {
        "schema": "libwebp-backref-cost-specialization-alignment-v3-authorization-v1",
        "authorization_status": "AUTHORIZED" if passed else "REFUSED",
        "status": "AUTHORIZED" if passed else "REFUSED",
        "phase_2_authority": "ALIGNMENT_V3_DIAGNOSTIC_ONLY" if passed else "NONE",
        "timed_execution_authorized": passed,
        "authorization_scope": (
            "Phase 2 may make exactly one frozen alignment-v3 diagnostic transaction; no production promotion, Phase 3, retry, or other workload is authorized."
            if passed else "Phase 2 is unauthorized."),
        "base_commit": "c208d6ed33b0ee5e84ba02e78696879266658e7e",
        "branch": "codex/backref-cost-specialization-alignment-v3",
        "source_commit": source_commit, "source_tree": source_tree,
