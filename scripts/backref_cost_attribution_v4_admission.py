#!/usr/bin/env python3
"""Shared fail-closed source admission for attribution-v4 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_attribution_v4_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    ...
    "src/enc/vp8l_enc.c",
    "src/enc/backref_cost_attribution_v4_experiment_enc.c",
    "src/enc/backref_cost_attribution_v4_experiment_enc.h",
    "tools/backref_cost_attribution_v4_experiment_runner.c",
    "scripts/backref_cost_attribution_v4_paths.py",
    "scripts/backref_cost_attribution_v4_admission.py",
    "scripts/execute_backref_cost_attribution_v4.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_attribution_v4_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-attribution-v4-source-admission-receipt-v1"
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="attribution-v4-admission-")
