#!/usr/bin/env python3
"""Canonical four-body identity domain for aligned-null attribution V3.
...
DOMAIN_SCHEMA = (
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-four-body-domain-v1"
)
EXPECTED_RECEIPT_SCHEMA = (
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-four-body-expected-receipt-v1"
)
ACTUAL_RECEIPT_SCHEMA = (
    "libwebp-backref-cost-aligned-null-stage-attribution-v3-four-body-actual-receipt-v1"
)
BOUNDARY_BYTES = 16384
SECTION_SEGMENT = "__TEXT"
SECTION_NAME = "__br_null_v3"
