#!/usr/bin/env python3
"""Untimed unit tests for v4 paths, repository-context admission, and sharing."""
...
import execute_backref_cost_workspace_remote_v4 as executor
from backref_cost_workspace_remote_v4_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="remote-v4-path-home-") as raw:
...
def main() -> int:
    ...
    shared_path_test()
    print("PASS: v4 canonical paths, repository-context bundle verification, "
