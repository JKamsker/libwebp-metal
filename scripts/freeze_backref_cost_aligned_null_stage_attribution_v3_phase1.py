#!/usr/bin/env python3
"""Generate fresh stage-attribution-v3 identity fixtures and freeze hashes."""
...
import backref_cost_aligned_null_stage_attribution_v3_payload as payload
...
import test_backref_cost_aligned_null_stage_attribution_v3_experiment as experiment_test


ROOT = Path(__file__).resolve().parents[1]
MANIFEST = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v3_manifest.json"
EVIDENCE = ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v3-design"
...
def receipt_bindings(manifest: dict) -> dict:
    ...
    return {
        ...
        "generator_file_sha256": sha256(
            ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v3_identity.py"),
    }
...
def capture_codegen(build_root: Path, bindings: dict) -> None:
    ...
    runner = build_root / "backref_cost_aligned_null_stage_attribution_v3_experiment_runner"
    ...
    write_json(EVIDENCE / "phase1-local-codegen.json", {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-local-codegen-v1",
        "status": "PASS",
...
def audit_v4(v4_map: Path) -> None:
    ...
    write_json(EVIDENCE / "phase1-prior-evidence-audit.json", {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-prior-evidence-audit-v1",
        ...
        "v4_timing_rows_loaded_into_v3_statistics": 0,
        ...
        "v1_authority_audit": {
            ...
            "can_contribute_samples_to_v3": False,
            "status": "PASS_SOLE_STALE_SIX_BODY_GATE_ZERO_ROWS",
        },
        "v1_timing_rows_loaded_into_v3_statistics": 0,
...
def audit_request_transport_requalification() -> None:
    """Machine-freeze successful Alignment V3/V4 and failed null V2 transfer."""
    variants = {
        "alignment-v3": {
            "prefix": "backref_cost_specialization_alignment_v3",
            "design": "backref-cost-specialization-alignment-v3-design",
        },
        "alignment-v4": {
    ...
    comparison = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-transport-comparison-v1",
        ...
        "source_differences": [{
            "variants": ["alignment-v3", "alignment-v4/aligned-null-v2"],
            "difference": "Alignment V3 did not mark its directly spawned Popen as transport_child; Alignment V4 and null V2 did.",
    ...
    prior.update({
        ...
        "transport_comparison_path":
            "evidence/backref-cost-aligned-null-stage-attribution-v3-design/transport-comparison.json",
...
def capture_local_untimed_evidence() -> dict:
    ...
    value = json.loads(run([
        "python3",
        str(ROOT / "scripts/test_backref_cost_aligned_null_stage_attribution_v3_experiment.py")
    ]).strip())
...
def fresh_identities(manifest: dict) -> None:
    ...
    payload_fixture = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-payload-fixture-v1",
    ...
    payload_agreement = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-payload-agreement-v1",
        "status": "PASS",
        ...
        "generator_path": "scripts/backref_cost_aligned_null_stage_attribution_v3_payload.py",
        "generator_file_sha256": sha256(ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v3_payload.py"),
    ...
    write_json(toolchain_fixture_path, {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-toolchain-fixture-v1",
        "identity": toolchain_identity,
    })
    identity_digest = canonical_sha256(toolchain_identity)
    toolchain_agreement = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-toolchain-agreement-v1",
        "status": "PASS",
    ...
    manifest["build"].update({
        ...
        "identity_rule":
            "one recorder-free Mach-O serves B/L; -no_deduplicate preserves four bodies; __TEXT,__br_null_v3 contains Push B/L then DP B/L at exact 16 KiB entry spacing",
    })
...
def freeze_request_channel_sizes(manifest: dict) -> dict:
    ...
    bootstrap_path = ROOT / \
        "scripts/backref_cost_aligned_null_stage_attribution_v3_bootstrap.py"
    bootstrap_sha = sha256(bootstrap_path)
    request = transport.build_channel_request(
        (ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v3_transport.py").read_bytes(),
        (ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v3_payload.py").read_bytes(),
    ...
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v3-base-bundle-") as raw:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v3-request-size-freeze-v1",
        ...
        "progress_chain_worst_case_json_bytes":
            len(transport.canonical_json({
                "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-request-progress-chain-v1",
                "rows": [{
...
def freeze_local_validation(manifest: dict, request_sizes: dict) -> None:
    ...
    write_json(EVIDENCE / "phase1-local-validation.json", {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v3-phase1-local-validation-v1",
        ...
        "checks": {
            ...
            "mach_o_section": "PASS___TEXT___br_null_v3_EXECUTABLE_PURE_INSTRUCTIONS",
        ...
        "commands": [
            "python3 -m py_compile scripts/*aligned_null_stage_attribution_v3*.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_payload_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_toolchain_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_process_ownership.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_archive.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_streaming.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_admission.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_experiment.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v3_protocol.py",
...
def freeze_source_admission_control(manifest: dict) -> dict:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v3-control-freeze-v1",
        "status": "PASS",
        "construction":
            "actual backref_cost_aligned_null_stage_attribution_v3_transport.canonical_json and _encoded_json",
