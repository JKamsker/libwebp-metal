#!/usr/bin/env python3
"""Minimal remote request-channel bootstrap for Alignment V4.
...
READY_SCHEMA = "libwebp-backref-cost-specialization-alignment-v4-ready-v1"
DECLARATION_SCHEMA = \
    "libwebp-backref-cost-specialization-alignment-v4-request-declaration-v1"
ACK_SCHEMA = "libwebp-backref-cost-specialization-alignment-v4-request-ack-v1"
RESPONSE_SCHEMA = \
...
def main() -> int:
    ...
    sequence = 0
    nonce = os.environ.get("WEBP_ALIGNMENT_V4_TRANSACTION_NONCE", "")
    expected_declaration_sha = os.environ.get(
        "WEBP_ALIGNMENT_V4_REQUEST_DECLARATION_SHA256", "")
    bootstrap_sha = os.environ.get("WEBP_ALIGNMENT_V4_BOOTSTRAP_SHA256", "")
    ...
    try:
        ...
        try:
            emit(output, "channel-refusal", {
                "schema": "libwebp-backref-cost-specialization-alignment-v4-channel-refusal-v1",
