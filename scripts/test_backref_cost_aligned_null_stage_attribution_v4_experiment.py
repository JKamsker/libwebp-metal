...
BUILD = "WEBP_BUILD_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_EXPERIMENT"
RECORDER = "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_RECORDER"
MACRO = "WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_EXPERIMENT"
RUNTIME = "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_VARIANT"
RUNNER = "backref_cost_aligned_null_stage_attribution_v4_experiment_runner"
...
def main() -> int:
    ...
    assert "VP8LBackrefCostAlignedNullStageAttributionV4GetVariant" in source
    ...
    with tempfile.TemporaryDirectory(
        ...
        assert b"SPECIALIZATION_ALIGNED_NULL_STAGE_ATTRIBUTION_V4" not in ordinary_archive
        ...
        assert "AlignedNullStageAttributionV4RecordPush" not in timed_nm
        assert "AlignedNullStageAttributionV4RecordPush" in recorder_nm
        ...
        section_map_rows = [line for line in map_text.splitlines()
                            if "__TEXT\t__br_null_v4" in line]
        ...
        for variant in ("B", "L"):
            ...
            environment = {
                ...
                "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_STAGE_OUTPUT":
                    str(stage),
                "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_RUN_ID":
                    f"local-timer-{variant}",
                "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_CASE_ID":
                    "local",
