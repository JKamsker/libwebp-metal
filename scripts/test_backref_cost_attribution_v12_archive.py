#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v12 indexed evidence archive protocol."""
...
import backref_cost_attribution_v12_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v12-archive-test-") as raw:
