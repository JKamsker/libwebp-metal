#!/usr/bin/env python3
"""Shared fail-closed source admission for interval-specialization-v1 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_interval_specialization_v1_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    "src/enc/backward_references_cost_enc.c",
    "src/enc/backref_cost_interval_specialization_v1_experiment_enc.c",
    "src/enc/backref_cost_interval_specialization_v1_experiment_enc.h",
    "tools/backref_cost_interval_specialization_v1_experiment_runner.c",
    "scripts/backref_cost_interval_specialization_v1_paths.py",
    "scripts/backref_cost_interval_specialization_v1_admission.py",
    "scripts/execute_backref_cost_interval_specialization_v1.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_interval_specialization_v1_manifest.json"
SOURCE_RECEIPT_SCHEMA = \
    "libwebp-backref-cost-interval-specialization-v1-source-admission-receipt-v1"
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="interval-specialization-v1-admission-")
