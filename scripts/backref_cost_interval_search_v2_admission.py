#!/usr/bin/env python3
"""Shared fail-closed source admission for interval-search-v2 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_interval_search_v2_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    "src/enc/backward_references_cost_enc.c",
    "src/enc/backref_cost_interval_search_v2_experiment_enc.c",
    "src/enc/backref_cost_interval_search_v2_experiment_enc.h",
    "tools/backref_cost_interval_search_v2_experiment_runner.c",
    "scripts/backref_cost_interval_search_v2_paths.py",
    "scripts/backref_cost_interval_search_v2_admission.py",
    "scripts/execute_backref_cost_interval_search_v2.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_interval_search_v2_manifest.json"
SCOPED_NAMES = {
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="interval-search-v2-admission-")
