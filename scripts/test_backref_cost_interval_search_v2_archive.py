#!/usr/bin/env python3
"""Untimed tests for the frozen interval-search v2 indexed evidence archive protocol."""
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="interval-search-v2-archive-test-") as raw:
