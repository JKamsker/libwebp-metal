#!/usr/bin/env python3
"""Exact attribution-v6 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-attribution-v6"
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-attribution-v6-path-round-trip-v1",
