#!/usr/bin/env python3
"""Static, workload-free ownership guards for attribution v15."""
...
import run_backref_cost_attribution_v15_experiment as operator_module


ROOT = Path(__file__).resolve().parents[1]
INFRASTRUCTURE = (
    "scripts/backref_cost_attribution_v15_admission.py",
    "scripts/backref_cost_attribution_v15_archive.py",
    "scripts/backref_cost_attribution_v15_paths.py",
    "scripts/backref_cost_attribution_v15_transport.py",
    "scripts/execute_backref_cost_attribution_v15.py",
    "scripts/run_backref_cost_attribution_v15_experiment.py",
)
...
def static_guards() -> None:
    ...
    assert signal_sites == [
        ("scripts/backref_cost_attribution_v15_admission.py", "self.process.kill")]
    assert popen_sites == ["scripts/backref_cost_attribution_v15_admission.py"]
...
def identity_only_process_contract() -> None:
    ...
    ignored_ancestor_argv_and_source = (
        "python3 -c 'backref_cost_attribution_v15_experiment_runner "
    ...
    lookalikes = (
        ...
        "prefix_backref_cost_attribution_v15_experiment_runner",
        "backref_cost_attribution_v15_experiment_runner_suffix",
...
def operator_refusal_control_contract() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="attribution-v15-refusal-") as raw:
...
def single_session_contract() -> None:
    ...
    source = (ROOT / "scripts/execute_backref_cost_attribution_v15.py").read_text()
    ...
    remote = (ROOT / "scripts/backref_cost_attribution_v15_transport.py").read_text()
...
def main() -> int:
    ...
    print("PASS: attribution v15 proves arbitrary opaque ancestors structurally, "
