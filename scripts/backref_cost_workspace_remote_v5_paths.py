#!/usr/bin/env python3
"""Exact remote v5 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-workspace-remote-v5"
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-workspace-remote-v5-path-round-trip-v1",
