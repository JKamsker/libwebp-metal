#!/usr/bin/env python3
"""Shared fail-closed source admission for remote-v4 rehearsal and execution."""
...
HOST = "pandocs-agent"
PATH_GUARD = ROOT / "scripts" / "backref_cost_workspace_remote_v4_paths.py"
IDENTITY_PATHS = (
    "CMakeLists.txt",
    "makefile.unix",
    "src/enc/backward_references_cost_enc.c",
    "src/enc/backref_cost_workspace_remote_v4_experiment_enc.c",
    "src/enc/backref_cost_workspace_remote_v4_experiment_enc.h",
    "tools/backref_cost_workspace_remote_v4_experiment_runner.c",
    "scripts/backref_cost_workspace_remote_v4_paths.py",
    "scripts/backref_cost_workspace_remote_v4_admission.py",
    "scripts/execute_backref_cost_workspace_remote_v4.py",
)
PROTOCOL_MANIFEST = ROOT / "scripts" / "backref_cost_workspace_remote_v4_manifest.json"
SCOPED_NAMES = {
...
def admit_source(*, exercise_malformed: bool) -> dict:
    ...
    temporary = tempfile.TemporaryDirectory(prefix="remote-v4-admission-")
