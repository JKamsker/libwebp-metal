#!/usr/bin/env python3
"""Frozen independent evaluator for aligned-null stage-attribution V1."""
...
def evaluate(evidence: Path) -> dict:
    ...
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-evaluation-v1",
