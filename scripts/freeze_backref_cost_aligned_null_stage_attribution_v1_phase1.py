#!/usr/bin/env python3
"""Generate fresh stage-attribution-v1 identity fixtures and freeze hashes."""
...
import backref_cost_aligned_null_stage_attribution_v1_payload as payload
...
import test_backref_cost_aligned_null_stage_attribution_v1_experiment as experiment_test


ROOT = Path(__file__).resolve().parents[1]
MANIFEST = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_manifest.json"
EVIDENCE = ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v1-design"
...
def capture_codegen(build_root: Path) -> None:
    ...
    runner = build_root / "backref_cost_aligned_null_stage_attribution_v1_experiment_runner"
    ...
    symbols = ["PushInterval", "PushIntervalLayoutClone",
    ...
    if experiment_test.canonical_instructions(runner, symbols[0]) != \
            ...
            experiment_test.canonical_instructions(runner, symbols[2]) != \
    ...
    section_rows = [line for line in map_text.splitlines()
                    if "__TEXT\t__br_null_v1" in line]
    if len(map_rows) != 4 or len(section_rows) != 1:
    ...
    write_json(EVIDENCE / "phase1-local-codegen.json", {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-local-codegen-v1",
        "status": "PASS",
        ...
        "dp_to_push_displacement_bytes": 32768,
        "section_segment": "__TEXT",
        "section_name": "__br_null_v1",
        ...
        "all_four_symbol_addresses_distinct": len(set(values.values())) == 4,
        "linker_identical_code_deduplication_disabled": True,
    })


def audit_v4(v4_map: Path) -> None:
    """Audit merged Alignment V4 without importing any row into V1."""
    EVIDENCE.mkdir(parents=True, exist_ok=True)
    ...
    write_json(EVIDENCE / "phase1-prior-evidence-audit.json", {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-prior-evidence-audit-v1",
        ...
        "evaluator_reconstruction": {
            ...
            "graphic_m4_dp_total_null_passed": True,
            "graphic_m4_dp_steady_null_passed": True},
        ...
        "v4_timing_rows_loaded_into_v1_statistics": 0,
...
def fresh_identities(manifest: dict) -> None:
    ...
    payload_fixture = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-payload-fixture-v1",
    ...
    payload_agreement = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-payload-agreement-v1",
        "status": "PASS",
        ...
        "generator_path": "scripts/backref_cost_aligned_null_stage_attribution_v1_payload.py",
        "generator_file_sha256": sha256(ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_payload.py"),
    ...
    write_json(toolchain_fixture_path, {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-toolchain-fixture-v1",
        "identity": toolchain_identity,
    })
    identity_digest = canonical_sha256(toolchain_identity)
    toolchain_agreement = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-toolchain-agreement-v1",
        "status": "PASS",
    ...
    manifest["build"].update({
        ...
        "identity_rule":
            "one recorder-free Mach-O serves B/L; -no_deduplicate preserves four bodies; __TEXT,__br_null_v1 contains Push B/L then DP B/L at exact 16 KiB entry spacing",
    })
...
def freeze_request_channel_sizes(manifest: dict) -> dict:
    ...
    request = transport.build_channel_request(
        (ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_transport.py").read_bytes(),
        (ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_payload.py").read_bytes(),
    ...
    with tempfile.TemporaryDirectory(prefix="stage-attribution-v1-base-bundle-") as raw:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v1-request-size-freeze-v1",
...
def freeze_local_validation(manifest: dict, request_sizes: dict) -> None:
    ...
    write_json(EVIDENCE / "phase1-local-validation.json", {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v1-phase1-local-validation-v1",
        ...
        "checks": {
            ...
            "mach_o_section": "PASS___TEXT___br_null_v1_EXECUTABLE_PURE_INSTRUCTIONS",
            ...
            "global_experiment_mutual_exclusion": "PASS_45_GUARDS",
        ...
        "frozen_inventory": {
            ...
            "bootstrap_resamples": 100000, "bootstrap_seed": "0x4e554c31",
        },
        "acceptance_freeze": {
        ...
        "commands": [
            "python3 -m py_compile scripts/*aligned_null_stage_attribution_v1*.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_payload_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_toolchain_identity.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_process_ownership.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_archive.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_streaming.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_admission.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_experiment.py",
            "PYTHONPATH=scripts python3 scripts/test_backref_cost_aligned_null_stage_attribution_v1_protocol.py",
...
def freeze_source_admission_control(manifest: dict) -> dict:
    ...
    value = {
        "schema":
            "libwebp-backref-cost-aligned-null-stage-attribution-v1-control-freeze-v1",
        "status": "PASS",
        "construction":
            "actual backref_cost_aligned_null_stage_attribution_v1_transport.canonical_json and _encoded_json",
