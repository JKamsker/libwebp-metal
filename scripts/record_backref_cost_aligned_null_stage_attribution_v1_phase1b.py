#!/usr/bin/env python3
"""Record the sole stage-attribution-v1 rehearsal as Phase 1B evidence."""
...
DESIGN = ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v1-design"
...
PROTOCOL = ROOT / "doc/backref-cost-aligned-null-stage-attribution-v1-protocol-20260820.md"
SCHEMAS = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_schemas.json"
TRANSPORT = ROOT / "scripts/backref_cost_aligned_null_stage_attribution_v1_transport.py"
...
def success_gate(source_commit: str, source_tree: str,
    ...
    checks = {
        ...
        "source admission verified":
            ...
            isinstance(source_rows, list) and len(source_rows) == 66 and
...
def main() -> int:
    ...
    rows = artifact_rows()
    index = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-phase1b-hash-index-v1",
    ...
    authorization = {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v1-authorization-v1",
        ...
        "authorization_scope": (
            "Phase 2 may make exactly one frozen stage-attribution-v1 diagnostic transaction. No performance sample is admitted until dynamic correctness, timer-accounting, and online direct-child gates pass inside that invocation; no production promotion, retry, or other workload is authorized."
            if passed else "Phase 2 is unauthorized."),
        "base_commit": "5de7b3848adfdb5d1058a061979535f05f976e5b",
        "branch": "codex/backref-cost-aligned-null-stage-attribution-v1",
        "source_commit": source_commit, "source_tree": source_tree,
