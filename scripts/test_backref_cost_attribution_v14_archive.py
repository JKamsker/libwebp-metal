#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v14 indexed evidence archive protocol."""
...
import backref_cost_attribution_v14_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v14-archive-test-") as raw:
        ...
        stages = [
            {"schema": "libwebp-backref-cost-attribution-v14-stage-v1",
