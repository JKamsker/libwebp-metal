#!/usr/bin/env python3
"""Frozen attribution-v7 indexed archive builder and extractor."""
...
ARCHIVE_SCHEMA = "libwebp-backref-cost-attribution-v7-archive-v1"
INVENTORY_SCHEMA = "libwebp-backref-cost-attribution-v7-archive-inventory-v1"
ARTIFACT_SCHEMA = "libwebp-backref-cost-attribution-v7-artifact-hashes-v1"
RETURNED_SCHEMA = (
    "libwebp-backref-cost-attribution-v7-returned-evidence-hashes-v1")
CHUNK = 1024 * 1024
