...
RECEIPT = ROOT / "evidence/backref-cost-aligned-null-stage-attribution-v3-design/four-body-expected-receipt.json"
...
def main() -> int:
    ...
    authority = (ROOT / "scripts/record_backref_cost_aligned_null_stage_attribution_v3_phase1b.py").read_text()
