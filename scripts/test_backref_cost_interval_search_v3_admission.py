...
from backref_cost_interval_search_v3_paths import (
...
def path_tests() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="interval-search-v3-path-home-") as raw:
...
def repository_context_admission_tests() -> None:
    with tempfile.TemporaryDirectory(prefix="interval-search-v3-admit-test-") as raw:
