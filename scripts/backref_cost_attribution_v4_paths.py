#!/usr/bin/env python3
"""Exact attribution-v4 run-directory generator, validator, and cleanup guard."""
...
SAFE_ROOT_BASENAME = ".libwebp-metal-backref-cost-attribution-v4"
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-attribution-v4-path-round-trip-v1",
