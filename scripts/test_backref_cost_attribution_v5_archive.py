#!/usr/bin/env python3
"""Untimed tests for the frozen interval-attribution v5 indexed evidence archive protocol."""
...
import backref_cost_attribution_v5_archive as protocol
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="attribution-v5-archive-test-") as raw:
