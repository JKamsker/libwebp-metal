#!/usr/bin/env python3
"""Fail-closed V4 representative-payload triple-agreement gate."""
...
import backref_cost_specialization_factorization_v4_payload as generator
import backref_cost_specialization_factorization_v4_transport as transport


ROOT = Path(__file__).resolve().parents[1]
MANIFEST = ROOT / "scripts/backref_cost_specialization_factorization_v4_manifest.json"
FIXTURE = (ROOT / "evidence/backref-cost-specialization-factorization-v4-design" /
           "representative-payload-fixture.json")
RECEIPT = (ROOT / "evidence/backref-cost-specialization-factorization-v4-design" /
           "representative-payload-agreement.json")


def independent_digest(size: int) -> str:
    domain = b"libwebp-backref-cost-specialization-factorization-v4-rehearsal\x00"
...
def main() -> int:
    ...
    assert stale_v2 not in observed and stale_v3 not in observed
