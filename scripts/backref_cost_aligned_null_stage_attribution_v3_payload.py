#!/usr/bin/env python3
"""Canonical deterministic stage-attribution-v3 payload generator."""
...
DOMAIN_TEXT = "libwebp-backref-cost-aligned-null-stage-attribution-v3-rehearsal\\0"
...
def identity() -> dict[str, object]:
    digest = sha256()
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-payload-identity-v1",
