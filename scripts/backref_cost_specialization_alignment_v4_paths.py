#!/usr/bin/env python3
"""Exact specialization-alignment-v4 run-directory generator, validator, and cleanup guard."""
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-specialization-alignment-v4-path-round-trip-v1",
