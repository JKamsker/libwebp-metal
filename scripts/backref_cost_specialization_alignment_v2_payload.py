#!/usr/bin/env python3
"""Canonical deterministic alignment-v2-domain representative-payload generator."""
...
DOMAIN_TEXT = "libwebp-backref-cost-specialization-alignment-v2-rehearsal\\0"
...
def identity() -> dict[str, object]:
    digest = sha256()
    return {
        "schema": "libwebp-backref-cost-specialization-alignment-v2-payload-identity-v1",
