#!/usr/bin/env python3
"""Fail-closed alignment-v3 representative-payload triple-agreement gate."""
...
import backref_cost_specialization_alignment_v3_payload as generator
...
FIXTURE = (ROOT / "evidence/backref-cost-specialization-alignment-v3-design" /
           "representative-payload-fixture.json")
RECEIPT = (ROOT / "evidence/backref-cost-specialization-alignment-v3-design" /
           "representative-payload-agreement.json")


def independent_digest(size: int) -> str:
    domain = b"libwebp-backref-cost-specialization-alignment-v3-rehearsal\x00"
...
def main() -> int:
    ...
    assert stale_v2 not in observed and stale_v3 not in observed and \
        ...
        stale_alignment_v2 not in observed
