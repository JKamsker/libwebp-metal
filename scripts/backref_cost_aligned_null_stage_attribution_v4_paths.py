#!/usr/bin/env python3
"""Exact stage-attribution-v4 run-directory generator and cleanup guard."""
...
def round_trip() -> dict:
    ...
    return {"schema": "libwebp-backref-cost-aligned-null-stage-attribution-v4-path-round-trip-v1",
