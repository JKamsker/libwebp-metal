#!/usr/bin/env python3
"""Canonical pinned-Xcode toolchain identity for Aligned Null Stage Attribution V3."""
...
def identity() -> dict[str, object]:
    ...
    return {
        "schema": "libwebp-backref-cost-aligned-null-stage-attribution-v3-toolchain-identity-v1",
