...
typedef enum {
  ...
  WEBP_PROFILE_LOSSY_DECIMATE,
  WEBP_PROFILE_LOSSY_RECORD_TOKENS,
  WEBP_PROFILE_LOSSY_ALPHA,
  WEBP_PROFILE_LOSSY_WRITE,
  WEBP_PROFILE_LOSSY_ITER_IMPORT,
  WEBP_PROFILE_LOSSY_SIDE_INFO,
  WEBP_PROFILE_LOSSY_SAVE_BOUNDARY,
  WEBP_PROFILE_LOSSY_EMIT_TOKENS,
  WEBP_PROFILE_LOSSY_POST_LOOP,
