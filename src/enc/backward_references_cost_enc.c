...
#endif
#if !defined(WEBP_BACKREF_ALIGNMENT_V1_ENTRY)
...
static WEBP_BACKREF_ATTRIBUTION_NOINLINE WEBP_BACKREF_ALIGNMENT_V1_ENTRY void
PushInterval(
...
#define BACKREF_DISTANCE_ONLY_ATTRIBUTES WEBP_BACKREF_ALIGNMENT_V1_ENTRY
#endif
