...
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_EXPERIMENT)
...
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_EXPERIMENT)
...
#define WEBP_FACTORIZATION_GET_VARIANT \
  VP8LBackrefCostSpecializationAlignmentV3GetVariant
...
#define VP8LBackrefCostIntervalSpecializationV1ExperimentInjectFallback() 0
    ...
    defined(WEBP_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_RECORDER) || \
    defined(WEBP_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_RECORDER) || \
    defined(WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_RECORDER) || \
    defined(WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V2_RECORDER) || \
    defined(WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_RECORDER) || \
    defined(WEBP_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_RECORDER) || \
    defined(WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_RECORDER)
#define WEBP_BACKREF_COST_INTERVAL_SPECIALIZATION_LOCAL_RECORDER 1
...
#define WEBP_BACKREF_ALIGNMENT_ENTRY WEBP_BACKREF_ALIGNMENT_V1_ENTRY
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V2_EXPERIMENT)
#define WEBP_BACKREF_ALIGNMENT_ENTRY WEBP_BACKREF_ALIGNMENT_V2_ENTRY
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT)
#define WEBP_BACKREF_ALIGNMENT_ENTRY WEBP_BACKREF_ALIGNMENT_V3_ENTRY
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT)
#define WEBP_BACKREF_ALIGNMENT_ENTRY WEBP_BACKREF_ALIGNMENT_V4_ENTRY
#elif defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT)
#define WEBP_BACKREF_ALIGNMENT_ENTRY \
  WEBP_BACKREF_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_ENTRY
#else
#define WEBP_BACKREF_ALIGNMENT_ENTRY
#endif
...
static WEBP_BACKREF_ATTRIBUTION_NOINLINE WEBP_BACKREF_ALIGNMENT_ENTRY void
PushInterval(
...
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_EXPERIMENT)
#include "src/enc/backref_cost_factorization_v3_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_EXPERIMENT)
#include "src/enc/backref_cost_factorization_v4_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT)
#include "src/enc/backref_cost_alignment_v1_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V2_EXPERIMENT)
#include "src/enc/backref_cost_alignment_v2_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT)
#include "src/enc/backref_cost_alignment_v3_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT)
#include "src/enc/backref_cost_alignment_v4_layout_clone_enc.inc"
#elif defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT)
...
#define BACKREF_DP_RECORD_CALL() ((void)0)
    ...
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT)
#define BACKREF_DISTANCE_ONLY_ATTRIBUTES WEBP_BACKREF_ALIGNMENT_ENTRY
#endif
#include "src/enc/backward_references_cost_distance_only_enc.inc"
    ...
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT)
#undef BACKREF_DISTANCE_ONLY_ATTRIBUTES
#endif
...
#undef BACKREF_DISTANCE_ONLY_NAME
    ...
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V3_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_FACTORIZATION_V4_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V1_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V2_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT) || \
    defined(WEBP_USE_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V4_EXPERIMENT) || \
...
int VP8LBackwardReferencesTraceBackwards(int xsize, int ysize,
...
#elif defined(WEBP_USE_BACKREF_COST_ATTRIBUTION_V16_EXPERIMENT)
  {
    ...
    defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V1_EXPERIMENT)
  {
    // Evaluate the selector exactly once before any selected DP can mutate
    // dist_array. The closed switch invokes exactly one noinline body.
