...
#if defined(_MSC_VER)
#define WEBP_ATTRIBUTION_V6_TLS __declspec(thread)
#else
#define WEBP_ATTRIBUTION_V6_TLS __thread
#endif

static WEBP_ATTRIBUTION_V6_TLS VP8LBackrefCostAttributionV6Counters counters;
