...
// alignment v3. Recorder declarations are absent from timed builds.

#ifndef WEBP_ENC_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT_ENC_H_
#define WEBP_ENC_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT_ENC_H_
...
} VP8LBackrefCostSpecializationAlignmentV3Stats;
...
void VP8LBackrefCostSpecializationAlignmentV3RecordInsert(int has_null_hint);
...
// while selecting fresh alignment-v3 recorder/control symbols.
...
#define WEBP_BACKREF_ALIGNMENT_V3_ENTRY                                  \
  __attribute__((noinline, used,                                         \
                 section("__TEXT,__br_align_v3,regular,pure_instructions"), \
                 aligned(16384)))
#elif defined(__GNUC__) || defined(__clang__)
#define WEBP_BACKREF_ALIGNMENT_V3_ENTRY                                  \
  __attribute__((noinline, used, section(".text.__br_align_v3"),        \
                 aligned(16384)))
#elif defined(_MSC_VER)
#define WEBP_BACKREF_ALIGNMENT_V3_ENTRY __declspec(noinline)
#else
#define WEBP_BACKREF_ALIGNMENT_V3_ENTRY
#endif
#else
...
#endif  // WEBP_ENC_BACKREF_COST_SPECIALIZATION_ALIGNMENT_V3_EXPERIMENT_ENC_H_
