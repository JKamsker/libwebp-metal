...
// Internal, independently guarded encoder stage profiling experiment.
    ...
    !defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_EXPERIMENT)
...
#define WEBP_FACTORIZATION_TIMERS_ENV \
  "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V3_TIMERS"
#define WEBP_FACTORIZATION_STAGE_OUTPUT_ENV \
...
#define WEBP_FACTORIZATION_TIMERS_ENV \
  "WEBP_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V4_TIMERS"
#define WEBP_FACTORIZATION_STAGE_OUTPUT_ENV \
...
void WebPProfileEndSession(int ok, int error_code) {
  ...
  record_schema =
      "libwebp-backref-cost-aligned-null-stage-attribution-v3-stage-ledger-v1";
#elif defined(WEBP_USE_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT)
  record_schema =
