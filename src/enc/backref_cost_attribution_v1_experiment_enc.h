// Copyright 2026
//
// Private controls for the diagnostic-only backref-cost attribution v1 build.

#ifndef WEBP_ENC_BACKREF_COST_ATTRIBUTION_V1_EXPERIMENT_ENC_H_
#define WEBP_ENC_BACKREF_COST_ATTRIBUTION_V1_EXPERIMENT_ENC_H_
...
#endif  // WEBP_ENC_BACKREF_COST_ATTRIBUTION_V1_EXPERIMENT_ENC_H_
