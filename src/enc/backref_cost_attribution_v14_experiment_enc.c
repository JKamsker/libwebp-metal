...
#if defined(_MSC_VER)
#define WEBP_ATTRIBUTION_V14_TLS __declspec(thread)
#else
#define WEBP_ATTRIBUTION_V14_TLS __thread
#endif

static WEBP_ATTRIBUTION_V14_TLS VP8LBackrefCostAttributionV14Counters counters;
