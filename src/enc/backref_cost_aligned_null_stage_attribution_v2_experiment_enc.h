...
// aligned null stage attribution v2. Recorder declarations are absent from timed builds.

#ifndef WEBP_ENC_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT_ENC_H_
#define WEBP_ENC_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT_ENC_H_
...
} VP8LBackrefCostAlignedNullStageAttributionV2Stats;
...
void VP8LBackrefCostAlignedNullStageAttributionV2RecordInsert(int has_null_hint);
...
#define WEBP_BACKREF_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_ENTRY                                  \
  __attribute__((noinline, used,                                         \
                 section("__TEXT,__br_null_v2,regular,pure_instructions"), \
                 aligned(16384)))
#elif defined(__GNUC__) || defined(__clang__)
#define WEBP_BACKREF_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_ENTRY                                  \
  __attribute__((noinline, used, section(".text.__br_null_v2"),        \
                 aligned(16384)))
#elif defined(_MSC_VER)
#define WEBP_BACKREF_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_ENTRY __declspec(noinline)
#else
#define WEBP_BACKREF_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_ENTRY
#endif
#else
...
#endif  // WEBP_ENC_BACKREF_COST_ALIGNED_NULL_STAGE_ATTRIBUTION_V2_EXPERIMENT_ENC_H_
