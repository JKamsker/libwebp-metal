...
#if defined(_MSC_VER)
#define WEBP_ATTRIBUTION_V3_TLS __declspec(thread)
#else
#define WEBP_ATTRIBUTION_V3_TLS __thread
#endif

static WEBP_ATTRIBUTION_V3_TLS VP8LBackrefCostAttributionV3Counters counters;
