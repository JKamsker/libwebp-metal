...
#if defined(_MSC_VER)
#define WEBP_ATTRIBUTION_V9_TLS __declspec(thread)
#else
#define WEBP_ATTRIBUTION_V9_TLS __thread
#endif

static WEBP_ATTRIBUTION_V9_TLS VP8LBackrefCostAttributionV9Counters counters;
