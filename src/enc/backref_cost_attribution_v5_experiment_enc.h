// Copyright 2026
//
// Private controls for the diagnostic-only backref-cost attribution v5 build.

#ifndef WEBP_ENC_BACKREF_COST_ATTRIBUTION_V5_EXPERIMENT_ENC_H_
#define WEBP_ENC_BACKREF_COST_ATTRIBUTION_V5_EXPERIMENT_ENC_H_
...
} VP8LBackrefCostAttributionV5Counters;

// Private diagnostic counters. They are thread-local, reset at every encoder
// profile session, and also exposed to the V5 runner for untimed structural
...
#if defined(WEBP_USE_BACKREF_COST_ATTRIBUTION_V5_EXPERIMENT)
#if defined(_MSC_VER)
...
#endif  // WEBP_ENC_BACKREF_COST_ATTRIBUTION_V5_EXPERIMENT_ENC_H_
